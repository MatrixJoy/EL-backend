...
func Load() (Config, error) {
	...
	return Config{
		...
		AppleClientID:           value("LEARNING_APPLE_CLIENT_ID", "VOA_APPLE_CLIENT_ID", "cn.wozdou.ela"),
		AppleTeamID:             os.Getenv("LEARNING_APPLE_TEAM_ID"),
		AppleKeyID:              os.Getenv("LEARNING_APPLE_KEY_ID"),
		ApplePrivateKeyBase64:   os.Getenv("LEARNING_APPLE_PRIVATE_KEY_BASE64"),
		AppleTokenEncryptionKey: os.Getenv("LEARNING_APPLE_TOKEN_ENCRYPTION_KEY"),
